...
# Database: dfcusa_pm
# Generation Time: 2015-07-03 19:48:47 +0000
# ************************************************************
...
INSERT INTO `files` (`id`, `project_id`, `stage`, `name`, `url`, `activity_id`)
VALUES
	(2,9,'feel','PI-BriefOverviewoftheTITANArchitecture-130515-0701-4.pdf','https://dfcusa_pm.s3.amazonaws.com/projects/9/PI-BriefOverviewoftheTITANArchitecture-130515-0701-4.pdf',24);
...
CREATE TABLE `invites` (
  ...
  `invited_timestamp` int(11) DEFAULT NULL,
  `accepted` int(1) DEFAULT NULL,
  `invite_token` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `invites` (`id`, `organization_id`, `email`, `name`, `invited_timestamp`, `accepted`, `invite_token`)
VALUES
	(4,1,'vinay.gidwaney@gmail.com','vinay2',1435952777,0,'4decd0e9fde0ce5ec231638a77b47dfe'),
	(5,1,'vinay.gidwaney@gmail.com','vdasiny1',1435952885,0,'bd852a3ddd151b8b2764cda52dcc22cf');
...
INSERT INTO `users` (`id`, `organization_id`, `first_name`, `last_name`, `location`, `email`, `password`, `security_hash`, `type`, `master_mentor`, `status`, `profilepic`, `created_timestamp`, `lastactive_timestamp`, `details_obj`)
VALUES
	(1,1,'Vinay','Gidwaney','Cambridge, MA','vinay.gidwaney@gmail.com','202cb962ac59075b964b07152d234b70','84410d8be11f79869eea756e7cc9df59','mentor',1,'active','https://media.licdn.com/mpr/mpr/shrink_120_120/p/2/000/0fc/2e4/19fe9a0.jpg',NULL,1435952897,NULL),
	(3,NULL,'Sanjli','Gidwaney','Cambridge, MA','admin@designforchange.us','202cb962ac59075b964b07152d234b70','admin','admin',0,'active','http://www.designforchange.us/images/team/sanjli.png',NULL,1431048287,NULL),
	(7,2,'Sherezada','Acosta','United States','sacosta@lrei.org','65c3d574951556b590657dfd4e3592c4','07aafee125c2c7cd9cd5825e5922380b','mentor',0,'active',NULL,NULL,1427985334,NULL),
	(8,3,'Cara','Adams','Cambridge, MA','cch273@mail.harvard.edu','4196f2f0aa07313cfadaaff987bbecd6','7e45fb834450e4089c895b938f80fdad','admin',0,'active',NULL,NULL,1431439724,NULL),
	(9,4,'Sample','Mentor','Cambridge, MA','sample@sample.com','202cb962ac59075b964b07152d234b70','0c58c3cdaf7d146c8efe1e9190261844','mentor',0,'active',NULL,NULL,1425398568,NULL),
	(10,3,'Molly','Levitt','Cambridge, MA','levitt@brightlooplearning.com ','4196f2f0aa07313cfadaaff987bbecd6','7e45fb834450e4089c895b938f80fdad','mentor',0,'active',NULL,NULL,1425865977,NULL),
	(11,3,'Nicole','Ramos','Cambridge, MA','nhr11a@acu.edu ','4196f2f0aa07313cfadaaff987bbecd6','7e45fb834450e4089c895b938f80fdad','mentor',0,'active',NULL,NULL,1425865977,NULL),
	(12,5,'Amanda','Maass','Dallas, Tx','maass.amanda@gmail.com','7df905156264af9d4f67ecb236802e8c','66a44c5b32988d3f162ce39a0baa7fae','mentor',0,'active',NULL,NULL,1426125125,NULL),
	(13,6,'Emily','Holding','Cambridge,MA','emholding16@aol.com','5e764a7475bc21c4766dc2baeefbe176','81ffb9f6444405cdd9648af2638cc34d','mentor',0,'active',NULL,NULL,1426126193,NULL),
	(14,7,'Amy','Hoffmaster','United States','amyhoffmaster@citizenschools.org','0ee966ea184c8ed86309bcc0eec6d8b5','873829891a85e5f98ce902a14334671d','mentor',0,'active',NULL,NULL,1430838064,NULL),
	(15,8,'Mikki','Pugh','United States','mpugh@swsg.org','65acd734b5d3802995563528e22014a9','d78e1a8570cfba27085d19d8a02af8e8','mentor',0,'active',NULL,NULL,1430414240,NULL),
	(16,9,'Hayling','Price','United States','hayling.price@gmail.com','d893bec0d12c3cc68d4fb4aa5e1fce7f','432fde66925d4a4ee5e95e1649130e57','mentor',0,'active',NULL,NULL,1430947173,NULL),
	(17,10,'Alice','Lin','Los Angeles, CA','alice@imagination.is','1347fb854c2daf9cc9089926115fd2ed','bc12646a3b0d200d7fe81156fa07ce05','mentor',0,'active',NULL,NULL,1431369396,NULL),
	(18,11,'Ellen','Pilon','North Hollywood, CA ','pilone@campbellhall.org','f70899980b1ccaa3b046273d119fe992','733a494b3588f1c842aa34d3da40c8da','mentor',0,'active',NULL,NULL,1431533388,NULL),
	(19,12,'Sangeeth','Peruri','United States','sangeethperuri@gmail.com','d78ccffccc57d10af2c6a8ffd06668e9','a0f1c36bb9be02ca59e96ef26f62e5f7','mentor',0,'active',NULL,NULL,1431629332,NULL),
	(20,1,'Claire','Teacher','Dallas, TX','test@tests.com','202cb962ac59075b964b07152d234b70','37a691d73c81c3c5d50bb587e236fd1f','mentor',0,'active','https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcSTh_Zl9iSWwZ5XfeA4SEi54OtwaMhFwrw4neMMAinfTsY_WmCv',NULL,1411589841,NULL),
	(24,1,'vinay','fasd','123','fdas@fdsa.com','202cb962ac59075b964b07152d234b70','9cf166301a1af50a9c2556760b8d691e','mentor',0,'active',NULL,NULL,1435952911,NULL);
